      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ">
          ...
          >
            ...
            <h4 className="text-lg font-bold">Rents Request For Your Cars!</h4>
              ...
              {favCars.map((car, i) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-blue-400 font-semibold">${car?.price}</p>
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {cars.length > 0 ? (
              ...
              <p className="text-gray-400"> You don't have any stored cars !</p>
            )}
          </div>
        </div>
        {/* My Rent Requests */}
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
            {usersReqs.length > 0 ? (
              ...
              <p className="text-gray-400">You don't have any rent request !</p>
            )}
          </div>
        </div>
